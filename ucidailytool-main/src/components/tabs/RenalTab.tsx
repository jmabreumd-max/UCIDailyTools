...
const RenalTab = () => {
  ...
  const urinePerHour = useMemo(() => { const u = parseFloat(urine24h); return u ? u / 24 : null; }, [urine24h]);
  ...
  return (
    <div className="space-y-4">
      ...
      <CollapsibleSection title="Débito Urinário"
        info={<InfoTooltip formula="DU = Urina 24h / 24 / Peso" reference="≥ 0.5 mL/kg/h" />}>
        <CalcField label="Diurese 24h" value={urine24h} onChange={setUrine24h} unit="mL" />
        {urinePerHour !== null && (
