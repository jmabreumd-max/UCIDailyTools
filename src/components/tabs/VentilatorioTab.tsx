        ...
        <>
          ...
          <CollapsibleSection title="Desmame Ventilatório"
            ...
            <div className="mt-2 text-[10px] space-y-2">
              <div className="bg-muted/30 rounded-lg p-2.5 border border-border">
                <p className="font-semibold text-primary mb-1">Critérios Pré-TRE e Extubação:</p>
                <ul className="list-disc pl-3 text-muted-foreground space-y-0.5">
                  <li><strong>Respiratório:</strong> P/F {">"} 150, FiO₂ ≤ 40%, PEEP ≤ 5-8 cmH₂O.</li>
                  <li><strong>Hemodinâmico:</strong> Sem isquémia aguda, ausência ou dose mínima de vasopressores/inotrópicos (ex: NA ≤ 0.1 mcg/kg/min).</li>
                  <li><strong>Neurológico:</strong> Doente acordado, cooperante (GCS {">"} 8), sem agitação.</li>
                  <li><strong>Mecânicos:</strong> Tosse eficaz, ausência de secreções copiosas. Volume alveolar/minuto e RSBI mantidos em PSV mínima (ex: PS 5-7, PEEP 5).</li>
                </ul>
              </div>
            </div>
          </CollapsibleSection>
